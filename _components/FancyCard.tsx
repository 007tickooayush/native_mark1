        ...
        <View style={styles.container}>
            ...
            <View style={[styles.cardImgContainer]}>
                ...
                <View style={styles.cardImgHeader}>
                    <Text style={[styles.cardImgHeaderText, textColor]}>Card Heading</Text>
                </View>
                <View style={styles.cardImgBody}>
                    <Text style={[styles.cardImgBodyText, textColor]}>
                ...
                <View style={styles.cardImgFooter}>
                    <Text style={[styles.cardImgFooterText, textColor]}>Card Footer</Text>
                </View>
            </View>
        </View>
    )
